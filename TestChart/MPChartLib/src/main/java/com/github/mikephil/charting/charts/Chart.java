...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends
        ...
        if (Build.VERSION.SDK_INT < 11) {
            ...
            mAnimator = new ChartAnimator(new AnimatorUpdateListener() {
                ...
                public void onAnimationStart(Animator animation) {
                    ...
                    if (mOnAnimationListener != null) mOnAnimationListener.onAnimationStart();
                }
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    if (mOnAnimationListener != null) mOnAnimationListener.onAnimationEnd();
                }
            });
        }
    ...
    @RequiresApi(11)
    public void setOnAnimationListener(OnAnimationListener l) {this.mOnAnimationListener = l;}

    public OnAnimationListener getOnAnimationListener() {return mOnAnimationListener; }
